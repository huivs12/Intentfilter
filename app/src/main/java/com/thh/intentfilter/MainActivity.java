...
//        intent.setClassName(getPackageName(), getPackageName()+".Activity2");
//        startActivity(intent);
        //隐式调用
        Intent intent = new Intent();
        intent.setAction("com.thh.intentfilter.MAIN2");
        intent.addCategory("com.thh.intentfilter.category.b2");
        intent.addCategory("com.thh.intentfilter.category.c3");
//        intent.setDataAndType(Uri.parse("content://com.wtalk.intentfilter:80/a/aa"), "image/jpeg");
        intent.setDataAndType(Uri.parse("file://com.wtalk.intentfilter/a/aa"), "image/jpeg");
        startActivity(intent);
    }
}
